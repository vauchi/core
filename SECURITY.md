...
- `vauchi-relay` - WebSocket server, rate limiting, message handling
- `vauchi-mobile` - UniFFI bindings, mobile-specific security
- `vauchi-android` - Android app, KeyStore integration
- `vauchi-ios` - iOS app, Keychain integration
- `vauchi-desktop` - Desktop app, secure storage
- `vauchi-cli` / `vauchi-tui` - Command-line tools
