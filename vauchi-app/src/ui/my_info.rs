...
// INLINE_TEST_REQUIRED: MyInfoViewMode is module-private, cannot be tested
// from external tests/. Extracted to my_info_tests.rs to keep this file
// under the src size limit.
#[cfg(test)]
#[path = "my_info_tests.rs"]
mod tests;
