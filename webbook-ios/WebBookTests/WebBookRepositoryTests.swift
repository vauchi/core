...
// Tests for WebBookRepository - based on features/*.feature Gherkin scenarios

import XCTest
@testable import WebBook

/// Tests for WebBookRepository
/// Based on: features/identity_management.feature, features/contact_card_management.feature
final class WebBookRepositoryTests: XCTestCase {
    ...
    func testNoIdentityOnFirstLaunch() throws {
        let repo = try WebBookRepository(dataDir: tempDir.path)
    ...
    func testIdentityPersistsAcrossSessions() throws {
        ...
        let repo2 = try WebBookRepository(dataDir: tempDir.path)
    ...
    func testCannotCreateIdentityTwice() throws {
        ...
        XCTAssertThrowsError(try repo.createIdentity(displayName: "Bob")) { error in
            guard case WebBookRepositoryError.alreadyInitialized = error else {
    ...
    func testImportBackup() throws {
        ...
        let repo2 = try WebBookRepository(dataDir: newDir.path)
