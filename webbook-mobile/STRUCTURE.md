...
| `WebBookMobile` | Main interface object with all operations |
...
| `WebBookMobile` | `uniffi::Object` | Main interface |

### `WebBookMobile` Methods
...
| Crate | Purpose |
|-------|---------|
| `webbook-core` | Core library (without network features) |
