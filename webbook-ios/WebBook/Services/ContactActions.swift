...
// Smart field actions for contact fields in WebBook iOS
...
enum ContactActions {
    ...
    static func detectFieldType(_ value: String) -> WebBookFieldType {
    ...
    static func buildUrl(for value: String, type: WebBookFieldType) -> URL? {
        let trimmed = value.trimmingCharacters(in: .whitespacesAndNewlines)
    ...
    static func availableActions(for type: WebBookFieldType) -> [Action] {
        switch type {
        case .phone:
    ...
    @MainActor
    static func openField(value: String, type: WebBookFieldType) {
