...
fn all_components() -> Vec<Component> {
    vec![
        ...
        Component::InlineConfirm {
            ...
            confirm_action_id: "confirm_ic".to_string(),
            cancel_action_id: "cancel_ic".to_string(),
            destructive: true,
            a11y: None,
        },
        Component::EditableText {
            ...
            edit_text: "Edit".to_string(),
            save_text: "Save".to_string(),
            cancel_text: "Cancel".to_string(),
            edit_action_id: "edit_et".to_string(),
            save_action_id: "save_et".to_string(),
            cancel_action_id: "cancel_et".to_string(),
            editing: false,
            validation_error: None,
            a11y: None,
            info_key: None,
...
fn no_forbidden_keys_in_screen_surface() {
    let screen = ScreenModel {
        ...
        contextual_actions: vec![sample_screen_action()],
