...
//!
//! This module re-exports the simple message protocol from webbook-core
//! for backward compatibility. New code should import directly from
//! `webbook_core::network::simple_message`.

// Re-export types from webbook-core's simple_message module
pub use webbook_core::network::simple_message::{
