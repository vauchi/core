...
#if canImport(webbook_mobileFFI)
import webbook_mobileFFI
#endif
...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_webbook_mobile_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_webbook_mobile_rustbuffer_free(self, $0) }
    }
}
 ...
 */
public protocol WebBookMobileProtocol : AnyObject {
 ...
 * Uses on-demand storage connections for thread safety.
 */
open class WebBookMobile:
    WebBookMobileProtocol {
    ...
    public func uniffiClonePointer() -> UnsafeMutableRawPointer {
        return try! rustCall { uniffi_webbook_mobile_fn_clone_webbookmobile(self.pointer, $0) }
    }
    /**
...
public convenience init(dataDir: String, relayUrl: String)throws  {
    ...
    uniffi_webbook_mobile_fn_constructor_webbookmobile_new(
    ...
    deinit {
        ...
        try! rustCall { uniffi_webbook_mobile_fn_free_webbookmobile(pointer, $0) }
    }
...
open func addField(fieldType: MobileFieldType, label: String, value: String)throws  {try rustCallWithError(FfiConverterTypeMobileError.lift) {
    uniffi_webbook_mobile_fn_method_webbookmobile_add_field(self.uniffiClonePointer(),
...
open func completeExchange(qrData: String)throws  -> MobileExchangeResult {
    ...
    uniffi_webbook_mobile_fn_method_webbookmobile_complete_exchange(self.uniffiClonePointer(),
...
open func contactCount()throws  -> UInt32 {
    ...
    uniffi_webbook_mobile_fn_method_webbookmobile_contact_count(self.uniffiClonePointer(),$0
    )
})
}
...
open func createIdentity(displayName: String)throws  {try rustCallWithError(FfiConverterTypeMobileError.lift) {
    uniffi_webbook_mobile_fn_method_webbookmobile_create_identity(self.uniffiClonePointer(),
...
open func exportBackup(password: String)throws  -> String {
    ...
    uniffi_webbook_mobile_fn_method_webbookmobile_export_backup(self.uniffiClonePointer(),
...
open func generateExchangeQr()throws  -> MobileExchangeData {
    ...
    uniffi_webbook_mobile_fn_method_webbookmobile_generate_exchange_qr(self.uniffiClonePointer(),$0
    )
})
}
...
open func getContact(id: String)throws  -> MobileContact? {
    ...
    uniffi_webbook_mobile_fn_method_webbookmobile_get_contact(self.uniffiClonePointer(),
...
open func getDisplayName()throws  -> String {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeMobileError.lift) {
    uniffi_webbook_mobile_fn_method_webbookmobile_get_display_name(self.uniffiClonePointer(),$0
    )
})
}
...
open func getOwnCard()throws  -> MobileContactCard {
    ...
    uniffi_webbook_mobile_fn_method_webbookmobile_get_own_card(self.uniffiClonePointer(),$0
    )
})
}
...
open func getProfileUrl(networkId: String, username: String) -> String? {
    ...
    uniffi_webbook_mobile_fn_method_webbookmobile_get_profile_url(self.uniffiClonePointer(),
...
open func getPublicId()throws  -> String {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeMobileError.lift) {
    uniffi_webbook_mobile_fn_method_webbookmobile_get_public_id(self.uniffiClonePointer(),$0
    )
})
}
...
open func getSyncStatus() -> MobileSyncStatus {
    ...
    uniffi_webbook_mobile_fn_method_webbookmobile_get_sync_status(self.uniffiClonePointer(),$0
    )
})
}
...
open func hasIdentity() -> Bool {
    ...
    uniffi_webbook_mobile_fn_method_webbookmobile_has_identity(self.uniffiClonePointer(),$0
    )
})
}
...
open func hideFieldFromContact(contactId: String, fieldLabel: String)throws  {try rustCallWithError(FfiConverterTypeMobileError.lift) {
    uniffi_webbook_mobile_fn_method_webbookmobile_hide_field_from_contact(self.uniffiClonePointer(),
...
open func importBackup(backupData: String, password: String)throws  {try rustCallWithError(FfiConverterTypeMobileError.lift) {
    uniffi_webbook_mobile_fn_method_webbookmobile_import_backup(self.uniffiClonePointer(),
...
open func isFieldVisibleToContact(contactId: String, fieldLabel: String)throws  -> Bool {
    ...
    uniffi_webbook_mobile_fn_method_webbookmobile_is_field_visible_to_contact(self.uniffiClonePointer(),
        FfiConverterString.lower(contactId),
        FfiConverterString.lower(fieldLabel),$0
    )
})
...
open func listContacts()throws  -> [MobileContact] {
    ...
    uniffi_webbook_mobile_fn_method_webbookmobile_list_contacts(self.uniffiClonePointer(),$0
    )
})
}
...
open func listSocialNetworks() -> [MobileSocialNetwork] {
    ...
    uniffi_webbook_mobile_fn_method_webbookmobile_list_social_networks(self.uniffiClonePointer(),$0
    )
})
}
...
open func pendingUpdateCount()throws  -> UInt32 {
    return try  FfiConverterUInt32.lift(try rustCallWithError(FfiConverterTypeMobileError.lift) {
    uniffi_webbook_mobile_fn_method_webbookmobile_pending_update_count(self.uniffiClonePointer(),$0
    )
})
}
...
open func removeContact(id: String)throws  -> Bool {
    return try  FfiConverterBool.lift(try rustCallWithError(FfiConverterTypeMobileError.lift) {
    uniffi_webbook_mobile_fn_method_webbookmobile_remove_contact(self.uniffiClonePointer(),
        FfiConverterString.lower(id),$0
    )
})
}
...
open func removeField(label: String)throws  -> Bool {
    return try  FfiConverterBool.lift(try rustCallWithError(FfiConverterTypeMobileError.lift) {
    uniffi_webbook_mobile_fn_method_webbookmobile_remove_field(self.uniffiClonePointer(),
...
open func searchContacts(query: String)throws  -> [MobileContact] {
    return try  FfiConverterSequenceTypeMobileContact.lift(try rustCallWithError(FfiConverterTypeMobileError.lift) {
    uniffi_webbook_mobile_fn_method_webbookmobile_search_contacts(self.uniffiClonePointer(),
...
open func searchSocialNetworks(query: String) -> [MobileSocialNetwork] {
    return try!  FfiConverterSequenceTypeMobileSocialNetwork.lift(try! rustCall() {
    uniffi_webbook_mobile_fn_method_webbookmobile_search_social_networks(self.uniffiClonePointer(),
        FfiConverterString.lower(query),$0
    )
})
}
...
open func setDisplayName(name: String)throws  {try rustCallWithError(FfiConverterTypeMobileError.lift) {
    uniffi_webbook_mobile_fn_method_webbookmobile_set_display_name(self.uniffiClonePointer(),
...
open func showFieldToContact(contactId: String, fieldLabel: String)throws  {try rustCallWithError(FfiConverterTypeMobileError.lift) {
    uniffi_webbook_mobile_fn_method_webbookmobile_show_field_to_contact(self.uniffiClonePointer(),
        FfiConverterString.lower(contactId),
        FfiConverterString.lower(fieldLabel),$0
    )
}
...
open func sync()throws  -> MobileSyncResult {
    ...
    uniffi_webbook_mobile_fn_method_webbookmobile_sync(self.uniffiClonePointer(),$0
    )
})
}
...
open func updateField(label: String, newValue: String)throws  {try rustCallWithError(FfiConverterTypeMobileError.lift) {
    uniffi_webbook_mobile_fn_method_webbookmobile_update_field(self.uniffiClonePointer(),
        FfiConverterString.lower(label),
...
open func verifyContact(id: String)throws  {try rustCallWithError(FfiConverterTypeMobileError.lift) {
    uniffi_webbook_mobile_fn_method_webbookmobile_verify_contact(self.uniffiClonePointer(),
        FfiConverterString.lower(id),$0
    )
}
}
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeWebBookMobile: FfiConverter {

    typealias FfiType = UnsafeMutableRawPointer
    typealias SwiftType = WebBookMobile

    public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> WebBookMobile {
        return WebBookMobile(unsafeFromRawPointer: pointer)
    }

    public static func lower(_ value: WebBookMobile) -> UnsafeMutableRawPointer {
        return value.uniffiClonePointer()
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> WebBookMobile {
    ...
    public static func write(_ value: WebBookMobile, into buf: inout [UInt8]) {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeWebBookMobile_lift(_ pointer: UnsafeMutableRawPointer) throws -> WebBookMobile {
    return try FfiConverterTypeWebBookMobile.lift(pointer)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeWebBookMobile_lower(_ value: WebBookMobile) -> UnsafeMutableRawPointer {
    return FfiConverterTypeWebBookMobile.lower(value)
}
...
private var initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_webbook_mobile_uniffi_contract_version()
    if bindings_contract_version != scaffolding_contract_version {
        return InitializationResult.contractVersionMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_add_field() != 63870) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_complete_exchange() != 1223) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_contact_count() != 50309) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_create_identity() != 45061) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_export_backup() != 43727) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_generate_exchange_qr() != 6386) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_get_contact() != 2017) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_get_display_name() != 40218) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_get_own_card() != 12870) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_get_profile_url() != 26882) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_get_public_id() != 32830) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_get_sync_status() != 54191) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_has_identity() != 8658) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_hide_field_from_contact() != 16087) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_import_backup() != 14171) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_is_field_visible_to_contact() != 38489) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_list_contacts() != 3637) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_list_social_networks() != 32928) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_pending_update_count() != 63009) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_remove_contact() != 8075) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_remove_field() != 25817) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_search_contacts() != 44205) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_search_social_networks() != 62897) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_set_display_name() != 13638) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_show_field_to_contact() != 15396) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_sync() != 35543) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_update_field() != 47840) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_method_webbookmobile_verify_contact() != 63186) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_webbook_mobile_checksum_constructor_webbookmobile_new() != 8085) {
        return InitializationResult.apiChecksumMismatch
    }
