...
final class SettingsServiceTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        let suiteName = "WebBookSettingsTests.\(UUID().uuidString)"
    ...
    func testDefaultRelayUrl() {
        XCTAssertEqual(SettingsService.defaultRelayUrl, "wss://relay.webbook.app")
    ...
    func testValidRelayUrls() {
        ...
        XCTAssertTrue(service.isValidRelayUrl("wss://relay.webbook.app"))
    ...
    func testInvalidRelayUrls() {
        ...
        XCTAssertFalse(service.isValidRelayUrl("https://relay.webbook.app"))
