...
//! Delivery domain persistence view (delivery_records).
//!
...
use super::super::error::{DeliveryRecord, DeliveryStatus};
use super::super::{Storage, StorageError};

/// Scoped persistence view for the deliveries domain.
...
impl Storage {
    /// Scoped persistence view for the deliveries domain.
    pub fn deliveries(&self) -> DeliveryStore<'_> {
        DeliveryStore {
            conn: &self.conn,
            clock: &self.clock,
        }
