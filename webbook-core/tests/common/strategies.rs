...
pub fn field_type_strategy() -> impl Strategy<Value = webbook_core::FieldType> {
    prop_oneof![
        Just(webbook_core::FieldType::Email),
        Just(webbook_core::FieldType::Phone),
        Just(webbook_core::FieldType::Website),
        Just(webbook_core::FieldType::Address),
        Just(webbook_core::FieldType::Social),
        Just(webbook_core::FieldType::Custom),
    ]
}
