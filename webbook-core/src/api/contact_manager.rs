...
impl<'a> ContactManager<'a> {
    ...
    pub fn get_own_card(&self) -> WebBookResult<Option<ContactCard>> {
    ...
    pub fn update_own_card(&self, card: &ContactCard) -> WebBookResult<Vec<String>> {
        ...
        if !changed_fields.is_empty() {
            self.events.dispatch(WebBookEvent::OwnCardUpdated {
    ...
    pub fn remove_field_from_own_card(&self, label: &str) -> WebBookResult<bool> {
        ...
        card.remove_field(&field_id)
            .map_err(|_| WebBookError::InvalidState("Field not found".into()))?;
    ...
    pub fn update_contact(&self, contact: &Contact) -> WebBookResult<Vec<String>> {
        ...
        if !changed_fields.is_empty() {
            self.events.dispatch(WebBookEvent::ContactUpdated {
                contact_id,
                changed_fields: changed_fields.clone(),
            });
        }
    ...
    pub fn remove_contact(&self, id: &str) -> WebBookResult<bool> {
        ...
        if existed {
            self.events.dispatch(WebBookEvent::ContactRemoved {
    ...
    pub fn verify_fingerprint(&self, id: &str) -> WebBookResult<()> {
    ...
    pub fn set_field_public(&self, contact_id: &str, field: &str) -> WebBookResult<()> {
    ...
    pub fn set_field_private(&self, contact_id: &str, field: &str) -> WebBookResult<()> {
        let mut contact = self.get_contact_required(contact_id)?;
...
mod tests {
    ...
    fn test_contact_not_found() {
        ...
        assert!(matches!(result, Err(WebBookError::ContactNotFound(_))));
    }
