...
proptest! {
    ...
    fn fuzz_ratchet_message_roundtrip(
        ...
        let msg = vauchi_core::crypto::ratchet::RatchetMessage {
        ...
        let deserialized: vauchi_core::crypto::ratchet::RatchetMessage =
...
proptest! {
    ...
    fn fuzz_visibility_rules_roundtrip(
        ...
        let mut rules = vauchi_core::VisibilityRules::new();
        ...
        let deserialized: vauchi_core::VisibilityRules =
            serde_json::from_str(&serialized).unwrap();
...
proptest! {
    ...
    fn fuzz_social_network_roundtrip(
        ...
        let network = vauchi_core::SocialNetwork::new(&id, &display_name, &url_template);

        let serialized = serde_json::to_string(&network).unwrap();
        let deserialized: vauchi_core::SocialNetwork =
            serde_json::from_str(&serialized).unwrap();
...
proptest! {
    ...
    fn fuzz_signing_corrupted_signature(
        ...
        use vauchi_core::crypto::{SigningKeyPair, Signature};
